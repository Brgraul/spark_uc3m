...
from listings.views import EventsView
from listings.views import BlogView
...
urlpatterns = [
    ...
    url(r'^contact/$', TemplateView.as_view(template_name='index__mp__slider_full_screen.html')),
]
